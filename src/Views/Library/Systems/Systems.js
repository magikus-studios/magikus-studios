...
export default function Function() {
    ...
    return (
        <div className="c-light-2 pb-4">
            <div className="pb-4">
                <h1 className="c-light-1">Welcome to Magikus Systems</h1>
                ...
                <h2 className="c-light-1">What Sets Magikus Systems Apart?</h2>
                <h5 className="c-light-3">Inexpensive</h5>
                <p>
                    Magikus Systems offer exceptional value without breaking the bank,
                    making them accessible to developers of all levels.
                </p>
                <h5 className="c-light-3">Robust</h5>
                <p>
                ...
                <h5 className="c-light-3">Well-Documented</h5>
                <p>
                ...
                <h5 className="c-light-3">Well-Tested</h5>
                <p>
                ...
                <h5 className="c-light-3">Time Saver</h5>
                <p>
                ...
                <h2 className="c-light-1">Unlock New Possibilities</h2>
                <p>
                ...
                <h2 className="c-light-1">Discover the Magic of Magikus Systems Today</h2>
                <p>
