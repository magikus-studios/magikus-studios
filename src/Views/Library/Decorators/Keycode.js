...
export default function Function() {
    ...
    return (
        <div className="c-light-2">           
            <h1 className="text-center pad-top-4">Keycode Drawer</h1>
            ...
            <p className="pad-left-2 pad-bottom-2">
                The Keycode drawer simplifies the process of setting KeyCode values in the Unity Editor, offering an intuitive and user-friendly interface. 
            ...
            <div className="p-2">
                <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Decorators/Keycode/Keycode - 03.jpg" alt=""/>            
            </div>
            ...
            <Group title="Implementation" content={(
                <div>
                    <p>
                        To use the Keycode drawer, ensure your script includes the KeyCode property you want to modify. 
                        The custom property drawer will automatically apply to all KeyCode fields in your scripts.
                    </p>
                    <img className="block-center mar-vertical-3 img-border w-50" src="images/Library/Decorators/Keycode/Keycode - 04.jpg" alt=""/>            
                </div>
            )}/>
            <Group title="Interface" content={(
                <div>
                    <p>
                        The Keycode drawer provides an enhanced UI for KeyCode fields, including:
                    </p>
                    <img className="block-center mar-vertical-3 img-border w-60" src="images/Library/Decorators/Keycode/Keycode - 05.jpg" alt=""/>            
                    <ul>
            ...
            <Group title="Example 01: Trying the KeyCode Drawer" content={(
                <div>
                    ...
                    <ol className="oList">
                        ...
                        <img className="block-center mar-vertical-3 img-border" src="images/Library/Decorators/Keycode/Keycode - 01.jpg" alt=""/>            
                        ...
                        <img className="block-center mar-vertical-3 img-border w-60" src="images/Library/Decorators/Keycode/Keycode - 01.gif" alt=""/>            
            ...
            <ul>
                ...
                <li>The Keycode drawer automatically applies to all KeyCode properties in the project. Ensure the custom drawer is compatible with your Unity version.</li>                
