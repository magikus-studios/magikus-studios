...
export default function Function() {
    ...
    return (
        <div className="c-light-2">           
            <h1 className="text-center">Hide Decorator</h1>
            <h6 className="ts-i text-center p-4 c-light-4 ft-secondary">
                The Hide attribute is a custom Unity attribute that provides conditional visibility for fields in the Unity Inspector. 
            ...
            <div className="p-3">
                <h4 className="c-light-1 pad-left-2">Hide Attribute</h4>
                ...
                <ul className="property-list">
                    <li><b1>HideAttribute</b1>(<b2>string</b2> <b1>propertyName</b1>): Initializes the attribute with the name of the property that determines visibility.</li>
                    <li><b1>HideAttribute</b1>(<b2>string</b2> <b1>propertyName</b1>, <b2>object</b2> <b1>value</b1>, <b2>params object[]</b2> <b1>alternativeValues</b1>): Initializes the attribute with the property name, a specific value, and optional alternative values that determine when the field should be visible.</li>
                </ul>
            ...
            <p className="pad-left-3">
                The Hide attribute is applied to fields within a MonoBehaviour or ScriptableObject class to control their visibility in the Unity Inspector based on another property. 
                Below are examples demonstrating its usage:
            </p>

            <h4 className="c-light-1 p-3">Example 01: Hide Field Based on a Boolean Property</h4>
            ...
            <h4 className="c-light-1 p-3">Example 02: Hide Field Based on an Enum Property</h4>
            ...
            <h4 className="c-light-1 p-3">Example 03: Hide Field Based on Multiple Values</h4>
            ...
            <h4 className="c-light-1 p-3">Example 04: Hide Field Based on a Reference Value</h4>
            ...
            <ul>
                <li>The Hide attribute uses reflection to evaluate the value of the specified property at runtime in the Unity Editor.</li>
            ...
            <p className="pad-left-2">
                The Hide attribute is a versatile and powerful tool for controlling the visibility of fields in the Unity Inspector based on the value of another property. 
