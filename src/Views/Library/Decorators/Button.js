        ...
        <div className="c-light-2">           
            ...
            <Group title="Example 04: Enabling and Disabling Buttons in Play Mode" content={(
                <div>
                    ...
                    <img className="block-center mar-bottom-3 img-border w-90" src="images/Library/Decorators/Button/Button - 08.jpg" alt=""/>            
                    <p>
                    ...
                    <img className="block-center mar-bottom-3 img-border w-40" src="images/Library/Decorators/Button/Button - 04.gif" alt=""/>            
                </div>
            )}/>           
