...
export default function Function() {
    ...
    return (
        <div className="c-light-2">           
            <h1 className="text-center pad-top-4">Timescale Asset</h1>
            <h6 className="ts-i text-center pad-bottom-3 c-light-4 ft-secondary">
                Structure designed to Facilitate the Synchronization of Time and Timescale between different Objects
            </h6>
            
            <h3 className="p-2">Overview</h3>
            <p className="pad-left-2 pad-bottom-2">
                The Timescale asset offers a robust and adaptable solution for managing and synchronizing time across multiple objects within a Unity project. 
            ...
            <div className="p-2">
                <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 08.jpg" alt=""/>            
            </div>

            <h3 className="p-2">Introduction</h3>
            <p className="pad-left-2">
                The Timescale structure can be used by both the Timescale structure and the Timescale asset, which implements the ITimescale interface. 
                ...
                This structure enables seamless control over multiple time scales at once.
                Rather than adjusting each individually, modifying the master scale automatically updates all linked instances. 
                To prevent infinite loops, the structure verifies master assignments before setting them, ensuring that circular dependencies are not created. 
            ...
            <Group title="ITimescale" content={(
                <div>
                    ...
                    <ul className="property-list">
                        ...
                        <li><b2>bool</b2> <b1>Pause</b1>: Enables or disables delta features. When Pause is true, all delta features return 0f.</li>
            ...
            <Group title="Timescale Asset : ITimescale" content={(
                <div>
                    ...
                    <h5 className="c-light-1">Methods</h5>
                    <ul className="property-list">
                        <li><b2>void</b2> <b1>SetScaleWithoutNotify</b1>(<b2>float</b2> <b1>scale</b1>): Sets the scale without triggering the onChange event</li>
            ...
            <p className="pad-left-2">
                The Timescale asset offers several properties and methods to manage and retrieve time-related values. 
            ...
            <ul>
                ...
                <li><b>Pause</b>: Enables or disables delta features. When Pause is true, all delta features return 0f.</li>
                ...
                <li><b>SetScaleWithoutNotify</b>: Sets the scale without triggering the onChange event</li>
            </ul>
            <p className="pad-left-2">
                You can create a Timescale asset by going to the Unity menu, <b1>Assets {">"} Create {">"} Magikus {">"} Timescale Assets {">"} Timescale Asset</b1>.
            </p>
            <Group title="Example 01: Basic Timescale Usage" content={(
                <div>
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 01.jpg" alt=""/>            
                    <p> 
                        This example demonstrates how to create and use a Timescale object in a script to control the speed of a rotating object.
                    </p>
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 02.jpg" alt=""/>            
                    <p> 
                    ...
                    <img className="block-center mar-bottom-3 img-border w-15" src="images/Library/Structures/Timescale/Timescale - 01.gif" alt=""/>            
                </div>
            )}/>
            <Group title="Example 02: Pausing Game Time" content={(
                <div>
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 03.jpg" alt=""/>            
                    <p> 
                        In this example, a TimescaleAsset is used to pause game time while keeping UI animations running.
                    </p>
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 04.jpg" alt=""/>            
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 05.jpg" alt=""/>            
                    <p> 
                    ...
                    <img className="block-center mar-bottom-3 img-border w-15" src="images/Library/Structures/Timescale/Timescale - 02.gif" alt=""/>            
                </div>
            )}/>
            <Group title="Example 03: Implementing Slow Motion Effect" content={(
                <div>
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 06.jpg" alt=""/>            
                    <p> 
                        This example showcases how to apply a slow motion effect to certain objects using a Timescale structure.
                    </p>
                    <img className="block-center mar-bottom-3 img-border w-60" src="images/Library/Structures/Timescale/Timescale - 07.jpg" alt=""/>            
                    <p> 
                    ...
                    <img className="block-center mar-bottom-3 img-border w-15" src="images/Library/Structures/Timescale/Timescale - 03.gif" alt=""/>            
                </div>
            )}/>
