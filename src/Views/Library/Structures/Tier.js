...
export default function Function() {
    ...
    return (
        <div className="c-light-2">           
            ...
            <Group title="Example 01: Basic Usage of IntTier" content={(
                <div>
            ...
            <Group title="Example 02: Advanced Usage with FloatTier" content={(
                <div>
            ...
            <Group title="Example 03: Handling Multiple Tiers with SubscribeList" content={(
                <div>
