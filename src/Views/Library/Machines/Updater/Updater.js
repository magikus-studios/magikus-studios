...
export default function Function() {
    ...
    return (
        <div className="c-light-2">           
            ...
            <h4 className="c-light-1 p-3">Methods</h4>

            <Method title="IUpdater Interface" content={(
                <ul className="property-list">
            ...
            <Method title="Updater Class" content={(
                <ul className="property-list">
            ...
            <img className="block-center pad-bottom-3" src="images/Library/Machines/Updater/Updater - 01.jpg" alt=""/>
