    ...
    return (
        <div className="c-light-2 pb-4">
            ...
            <SimpleDocBlock
                ...
                value="(-1, 1, 3)" operation="ClampXYZ" parameter="(0, 2)" result="(0, 1, 2)" />
            <SimpleDocBlock
                title="ClampRange:"
                ...
                value="(0, 2, 4)" operation="ClampRangeXYZ" parameter="(2, 1)" result="(1, 2, 3)" />
            <SimpleDocBlock
                title="ClampMin:"
                ...
                value="(-1, 1, 3)" operation="ClampMinZX" parameter="(2)" result="(2, 1, 3)" />
            <SimpleDocBlock
                title="ClampMax:"
                ...
                value="(-1, 1, 3)" operation="ClampMaxZX" parameter="(2)" result="(-1, 1, 2)" />
            <SimpleDocBlock
                title="ClampPos:"
                ...
                value="(-1, 1, 3)" operation="ClampPosZX" parameter="(2)" result="(0, 1, 2)" />
            <SimpleDocBlock
                title="ClampNeg:"
                ...
                value="(-1, 1, 3)" operation="ClampNegZX" parameter="(-2)" result="(-1, 1, 0)" />
            <SimpleDocBlock
                title="ClampAbs:"
                ...
                value="(-1, 1, 3)" operation="ClampAbsZX" parameter="(0.5)" result="(-0.5, 1, 0.5)" />
            <SimpleDocBlock
                title="ClampAbsOne:"
                ...
                value="(-2, 1, 3)" operation="ClampAbsOneZX" parameter="()" result="(-1, 1, 1)" />
            <SimpleDocBlock
                title="ClampBin:"
                ...
                value="(-1, 1, 3)" operation="ClampBinZX" parameter="()" result="(0, 1, 1)" />
        </div>
    );
}