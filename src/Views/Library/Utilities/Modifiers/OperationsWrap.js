    ...
    return (
        <div className="c-light-2 pb-4">
            ...
            <SimpleDocBlock
                ...
                value="(-1, 1, 3)" operation="WrapXYZ" parameter="(0, 2)" result="(1, 1, 1)" />
            <SimpleDocBlock
                title="WrapRange:"
                ...
                value="(-2, 1, 3)" operation="WrapRangeXYZ" parameter="(0, 1)" result="(1, 1, 0)" />
            <SimpleDocBlock
                title="WrapPos:"
                ...
                value="(-1, 1, 3)" operation="WrapPosZX" parameter="(2)" result="(2, 1, 0)" />
            <SimpleDocBlock
                title="WrapNeg:"
                ...
                value="(-3, 1, 1)" operation="WrapNegZX" parameter="(-2)" result="(0, 1, -2)" />
            <SimpleDocBlock
                title="WrapAbs:"
                ...
                value="(-3, 1, 3)" operation="WrapAbsZX" parameter="(2)" result="(2, 1, -2)" />
            <SimpleDocBlock
                title="WrapAbsOne:"
                ...
                value="(-2, 1, 3)" operation="WrapAbsOneZX" parameter="()" result="(1, 1, 0)" />
            <SimpleDocBlock
                title="WrapBin:"
                ...
                value="(-1, 1, 3)" operation="WrapBinZX" parameter="()" result="(1, 1, 1)" />
        </div>
    );
}