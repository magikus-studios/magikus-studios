...
export default function Function() {
    ...
    return (
        <div className="c-light-2">           
            <h1 className="text-center">Reference Console</h1>
            ...
            <ul className="property-list">
                <li><b>Expand</b>: Expands all reference entries to show detailed information.</li>
                <li><b>Collapse</b>: Collapses all reference entries to show only summary information.</li>
                <li><b>Refresh</b>: Manually refreshes the list of references based on the current selection and mode.</li>
                <li><b>Auto</b>: Toggles automatic refreshing of references when the selection changes.</li>
                <li><b>Mode Selection</b>: Allows you to select the scope of the reference search, including options for the open scene, all scenes, assets, or a combination of these.</li>
            </ul>
            <img className="block-center pad-bottom-4" src="images/Library/Tools/ReferenceConsole/Reference Console - 01.jpg" alt=""/>
            ...
            <ul className="property-list">
                <li><b>Open Scene</b>: Displays references within the currently open scene.</li>
                <li><b>Assets</b>: Displays references within all assets in the project.</li>
                <li><b>All Scenes</b>: Displays references across all scenes in the project.</li>
                <li><b>All</b>: Displays references across all scenes and assets.</li>
            </ul>
            ...
            <img className="block-center pad-bottom-4" src="images/Library/Tools/ReferenceConsole/Reference Console - 02.jpg" alt=""/>

            <h5 className="c-light-0 pad-left-3">Handling References</h5>
            <ul className="property-list">
                <li><b>Add to Selection</b>: To add an object to the selection, click the “+“ button next to a reference.</li>
                <li><b>Remove from Selection</b>: To remove an object from the selection, click the “-“ button next to the reference holder.</li>
            </ul>
